...
public class ClockEditorSupportConstraint extends javax.swing.JPanel {
  ...
  /** Creates new form ClockEditorSupportConstraint */
  public ClockEditorSupportConstraint() {
    initComponents();
  ...
  private void jtfTimeZoneOffsetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtfTimeZoneOffsetActionPerformed
    try {
      ...
      jtfTimeZoneOffset.setText(
      new Integer(getTimeZoneOffset()).toString());
    }
  ...
  throws java.beans.PropertyVetoException {
    ...
    vetoableChangeSupport.fireVetoableChange("timeZoneOffset",
